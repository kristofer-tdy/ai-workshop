        ...
        <>
          ...
          <motion.aside
            className="
              ...
              w-64 bg-bg-surface border-r border-text-muted/20
              flex flex-col
              lg:relative lg:z-0
            "
            initial={{ x: -256 }}
          ...
          >
            ...
            <div className="p-6 border-b border-text-muted/20">
              <Link href="/" className="flex items-center gap-2">
                ...
                <span className="font-display font-bold text-lg text-glow-cyan">
                  How LLMs Think
                </span>
              </Link>
            </div>
            ...
            <div className="p-4 border-t border-text-muted/20">
              <p className="text-xs text-text-muted text-center">
                Press{' '}
                <kbd className="px-1.5 py-0.5 bg-bg-elevated rounded text-text-secondary">
                  ?
                </kbd>{' '}
